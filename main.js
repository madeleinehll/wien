    ...
    L.geoJSON(jsondata, {
        pointToLayer: function(feature, latlng) {
            ...
            if (prop.KATEGORIE_TXT === "1*") {
                hotelIcon = "icons/hotel_1.png";
            } else if (prop.KATEGORIE_TXT === "2*") {
                hotelIcon = "icons/hotel_2.png";
            } else if (prop.KATEGORIE_TXT === "3*") {
                hotelIcon = "icons/hotel_3.png";
            } else if (prop.KATEGORIE_TXT === "4*") {
                hotelIcon = "icons/hotel_4.png";
            } else if (prop.KATEGORIE_TXT === "5*") {
                hotelIcon = "icons/hotel_5.png";
            } else {
                hotelIcon = "icons/hotel_0.png";
            }
            return L.marker(latlng, {
                icon: L.icon({
                    iconUrl: hotelIcon,
